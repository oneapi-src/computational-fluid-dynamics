...
'''
This script is for converting the
TF model to a frozen graph version
'''
...
from utils.train import MSE_flat
...
def main(flags):
    ...
    Args:
        flags : run flags
    """
    model = tf.keras.models.load_model(flags.keras_saved_model_dir, custom_objects={"MSE_flat": MSE_flat})
